...
/**
 * Created by AUGUSTIN on 30/04/2015.
 */
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public  void onCreate(SQLiteDatabase db){
        db.execSQL("CREATE TABLE " + TABLE_CONTACTS + "(" + KEY_ID + "INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_NAME + "TEXT " + KEY_PHONE + "TEXT" + KEY_PHONE + "TEXT" + KEY_EMAIL + "TEXT" + KEY_ADDRESS + "TEXT" + KEY_IMAGEURI + "TEXT )");
    }
    @Override
    ...
    public List<Contact> getAllContacts(){
        ...
        if(cursor.moveToFirst()){
            Contact contact;
            do{
                contact = new Contact(Integer.parseInt(cursor.getString(0)),cursor.getString(1),cursor.getString(2),cursor.getString(3) ,cursor.getString(4), Uri.parse(cursor.getString(5)));
